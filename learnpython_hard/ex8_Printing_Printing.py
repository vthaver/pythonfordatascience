...
print(formatter.format(formatter,formatter,formatter,formatter)) # It's going to return nothing (16 spaces) because there were no variables passed into the formatter(2nd degree)
